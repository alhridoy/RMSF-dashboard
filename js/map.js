...
// });
  ...
  var map = L.map('map').setView([34.0489, -111.0937], 4);
  ...
  info.update = function (props) {
    this._div.innerHTML = '<h4>Total number of cases</h4>' +  
      (props ? '<b>' + props.NAME + '</b><br />' + props.p + ' people ' : 'hover over the county');
  };
